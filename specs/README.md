...
| **v0.4.0** | Action recommendations (agentic, HITL)          | [spec](releases/v0.4.0-action-recommendations/spec.md) — Accepted         | [plan](releases/v0.4.0-action-recommendations/spec-imp.md) — Draft            |
